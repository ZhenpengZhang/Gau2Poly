...
#写入General信息
with open(Title+'//'+Title+'.dat', 'w', newline='\n') as dat:
...
if dictionary['REACT2']:
    ...
    with open(Title + '//' + Title + '.dat', 'a', newline='\n') as dat:
        dat.write('*REACT2\n\n'' INITGEO HOOKS\n\n')
        dat.write('GEOM\n')
...
if dictionary['REACT1']:
    with open(Title + '//' + Title + '.71', 'w', newline='\n') as file71:
...
#产生72文件
if dictionary['REACT2']:
    with open(Title + '//' + Title + '.72', 'w', newline='\n') as file72:
...
#产生73文件
if dictionary['PROD1']:
    with open(Title + '//' + Title + '.73', 'w', newline='\n') as file73:
...
#产生74文件
if dictionary['PROD2']:
    with open(Title + '//' + Title + '.74', 'w', newline='\n') as file74:
...
#产生75文件
if dictionary['START']:
    with open(Title + '//' + Title + '.75', 'w', newline='\n') as file75:
        file75.write('%mem=10GB\n''%nproc=48\n''%chk=guess.chk\n''# opt=(TS,noeigen,calcfc) scf(maxcycle=512,xqc) FCHK ' + str(Method) +' '+ str(Basis))
        file75.write('\n\n')
        ...
        file75.write('\n\n')
#产生70文件
    with open(Title + '//' + Title + '.70', 'w', newline='\n') as file:
        ...
        file.write('  END\n')
#生产jc文件
    with open(Title + '//' + Title + '.jc', 'w', newline='\n') as file:
...
with open(Title + '//' + Title + '.jc', 'a', newline='\n') as file:
    file.write(script)
#生成slurm提交脚本
slurm = """#!/bin/bash
...
#SBATCH --output=%j.out
"""
with open(Title + '//' + Title + '.slm', 'a', newline='\n') as file:
    file.write(slurm)
